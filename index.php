...
<head>
	...
	<title>Демо: лендинг «Поступление без ЕГЭ» (портфолио)</title>

	<meta property="og:title" content="Демо: лендинг «Поступление без ЕГЭ»">
	<meta property="og:description" content="Статичная демонстрация вёрстки для портфолио. Заявки и внешние сервисы отключены.">
			...
			<div class="container">
				<div class="header__content">
					<div class="header__logo">
						<img data-src="img/header/logo.svg" alt="Демо-проект" class="lazy">
						<span>Демо для портфолио</span>
					</div>
					...
					<div class="header__contacts">
						...
						<a href="#popup-reg" data-fancybox class="header__phone" title="Открыть форму (демо)"><img data-src="img/header/phone.svg" alt="" class="lazy"></a>
							...
							<div class="form__more">
								<label class="form__footer ">
									...
									<div class="form__footer-text">
										Нажимая на кнопку, вы соглашаетесь с <a href="https://example.com/demo/privacy" target="_blank" rel="noopener noreferrer" class="form__more-link">политикой конфиденциальности</a> и на получение рассылок
									</div>
								</label>
							</div>
					</div>
		...
		<footer class="footer">
			<div class="container">
				<div class="footer__box">
					<form class="form footer__form form_vertical" action="#" method="post">
						<div class="form__wrapper">
							<h2 class="form__title">Обратная связь (демо)</h3>
					...
					<div class="footer__content">
						<div class="footer__wrap">
							<ul class="footer__time">
								<li>График (выдуманный, для макета):</li>
				...
				<div class="footer__developer">
					...
					<a class="footer__developer-item" href="https://example.com/demo/privacy" target="_blank" rel="noopener noreferrer">Политика конфиденциальности (заглушка)</a>
				</div>
			</div>
		</footer>
					...
					<h2 class="form__title">Регистрация</h3>
						...
						<div class="form__more">
							<label class="form__footer ">
								...
								<div class="form__footer-text">
									Нажимая на кнопку, я соглашаюсь с <a href="https://example.com/demo/privacy" target="_blank" rel="noopener noreferrer" class="form__more-link">политикой конфиденциальности</a> и на получение рассылок
								</div>
							</label>
						</div>
				</div>
