...
<head>
	...
	<title>Демо: лимит заявок</title>

	<meta property="og:title" content="Демо: лимит заявок">
...
<body class="page-thanks">
	...
	<section class="thanks limit">
    <div class="container">
        <div class="limit__content">
            <h1 class="limit__title">Демо-страница.<br/>В реальном проекте здесь было&nbsp;бы сообщение о&nbsp;лимите заявок.</h1>
            <a class="thanks__button button" href="index.php">На главную</a>
        </div>
        <img data-src="img/main/picture.svg" alt="" class="lazy limit__img">
    </div>
</section>
